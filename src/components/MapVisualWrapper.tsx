...
const MapVisual = dynamic(() => import("./MapVisual"), {
    ssr: false,
    loading: () => (
        <div className="w-full h-[450px] rounded-3xl bg-black/20 animate-pulse border border-slate-200 dark:border-white/5 flex items-center justify-center shadow-2xl">
